...
class HrWithholdingTax(models.Model):
    ...
    # Tax amounts for dependents 0-7 (Column A)
    tax_dep_0 = fields.Integer(string='Tax (0 dependents)')
    tax_dep_1 = fields.Integer(string='Tax (1 dependent)')
    tax_dep_2 = fields.Integer(string='Tax (2 dependents)')
    tax_dep_3 = fields.Integer(string='Tax (3 dependents)')
    tax_dep_4 = fields.Integer(string='Tax (4 dependents)')
    tax_dep_5 = fields.Integer(string='Tax (5 dependents)')
    tax_dep_6 = fields.Integer(string='Tax (6 dependents)')
    tax_dep_7 = fields.Integer(string='Tax (7 dependents)')
    # Column B (for secondary jobs)
    tax_column_b = fields.Integer(string='Tax Column B')
