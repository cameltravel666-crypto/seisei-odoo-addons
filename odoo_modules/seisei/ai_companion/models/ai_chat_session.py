...
class AIChatMessage(models.Model):
    ...
    def _call_dify_api(self, user_message):
        ...
        base_url = params.get_param('ai_companion.dify_base_url', default='http://54.65.127.141:5001/v1')
        ...
        if not api_key:
            ...
            return (
                ...
                "3. 获取 API Key：<br/>"
                "   - 访问 <a href='http://54.65.127.141:3000/apps' target='_blank'>http://54.65.127.141:3000/apps</a><br/>"
                "   - 选择应用 → <b>API 访问</b> → 复制 API Key<br/>"
                "4. 设置 <b>Dify Base URL</b> 为：<code>http://54.65.127.141:5001/v1</code><br/>"
                "5. 保存设置"
            )
        ...
        try:
            ...
            if not answer:
                ...
                return (
                    ...
                    "3. 请求参数不正确<br/><br/>"
                    "建议：<br/>"
                    "1. 检查 Dify 应用配置：<a href='http://54.65.127.141:3000/apps' target='_blank'>http://54.65.127.141:3000/apps</a><br/>"
                    "2. 稍后重试<br/>"
            ...
            return (
                ...
                "3. 检查 Dify 服务状态：<a href='http://54.65.127.141:5001/health' target='_blank'>http://54.65.127.141:5001/health</a>"
            ) % timeout
            ...
            if status_code == 401 or status_code == 403:
                return (
                    ...
                    "1. 访问 Dify Web 界面：<a href='http://54.65.127.141:3000/apps' target='_blank'>http://54.65.127.141:3000/apps</a><br/>"
                    "2. 选择你的应用<br/>"
                    ...
                    "<b>检查 Base URL：</b><br/>"
                    "确保 <b>Dify Base URL</b> 设置为：<code>http://54.65.127.141:5001/v1</code>"
                ) % status_code
                ...
                return (
                    ...
                    "当前配置：<code>%s</code><br/>"
                    "应该设置为：<code>http://54.65.127.141:5001/v1</code><br/><br/>"
                    "检查步骤：<br/>"
                    "1. 确认 Dify API 服务运行在端口 5001<br/>"
                    "2. 测试 API：<a href='http://54.65.127.141:5001/health' target='_blank'>http://54.65.127.141:5001/health</a>"
                ) % base_url
                ...
                return (
                    ...
                    "Dify 服务器遇到了问题。请：<br/>"
                    "1. 稍后重试<br/>"
                    "2. 检查 Dify 服务状态：<a href='http://54.65.127.141:5001/health' target='_blank'>http://54.65.127.141:5001/health</a><br/>"
                    "3. 查看 Dify 日志排查问题"
                )
            else:
                return (
            ...
            return (
                ...
                "   - 当前配置：<code>%s</code><br/>"
                "   - 应该设置为：<code>http://54.65.127.141:5001/v1</code><br/>"
                "3. 测试 API 连接：<a href='http://54.65.127.141:5001/health' target='_blank'>http://54.65.127.141:5001/health</a><br/>"
            ...
            return (
                ...
                "2. 确认应设置为：<code>http://54.65.127.141:5001/v1</code><br/>"
                "3. 查看 Odoo 日志获取详细错误信息"
            ) % base_url
            ...
            return (
                ...
                "2. Dify 服务状态：<a href='http://54.65.127.141:5001/health' target='_blank'>http://54.65.127.141:5001/health</a><br/>"
                "3. 配置是否正确：<br/>"
                "   - API Key 已配置<br/>"
