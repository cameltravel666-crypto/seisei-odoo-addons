...
const STEP_PROGRESS: Record<ProvisioningStep, number> = {
  ...
  [ProvisioningStep.STEP_1_COPY_DB]: 10,
  [ProvisioningStep.STEP_2_ODOO18_AUTH]: 20,
  [ProvisioningStep.STEP_3_ODOO18_UPDATE_ADMIN]: 30,
  [ProvisioningStep.STEP_3B_ODOO18_SETUP_APIKEY]: 40,
  [ProvisioningStep.STEP_4_ODOO19_UPSERT_TENANT]: 50,
  [ProvisioningStep.STEP_4B_SEISEI_BILLING_TENANT]: 60,
...
const STEP_DESCRIPTIONS: Record<ProvisioningStep, { ja: string; en: string }> = {
  ...
  [ProvisioningStep.STEP_3B_ODOO18_SETUP_APIKEY]: { ja: 'APIキー設定中...', en: 'Setting up API key...' },
  [ProvisioningStep.STEP_4_ODOO19_UPSERT_TENANT]: { ja: 'テナント登録中...', en: 'Registering tenant...' },
  [ProvisioningStep.STEP_4B_SEISEI_BILLING_TENANT]: { ja: '課金システム登録中...', en: 'Registering in billing system...' },
