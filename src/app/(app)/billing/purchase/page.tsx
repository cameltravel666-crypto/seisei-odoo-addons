 ...
 * 発注・受領請求・支払の管理
 */
export default function BillingPurchasePage() {
      ...
      <div className="page-header-sticky">
        <div className="page-header-title flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="page-title">仕入（購買・支払）</h1>
          </div>
          <button
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="flex-1 grid grid-cols-5 gap-4 items-center text-sm">
                  ...
                  <span className="text-gray-600 truncate">{item.partnerName}</span>
