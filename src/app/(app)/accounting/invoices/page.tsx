...
import { OcrBatchButton, OcrStatusBadge, OcrCheckbox } from '@/components/ocr';
    ...
    <>
      {selectionMode && (
        <OcrCheckbox
          ...
          disabled={!invoice.hasAttachment}
        />
      )}
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-0.5">
          ...
          {getStatusBadge()}
          {invoice.hasAttachment && invoice.ocrStatus && invoice.ocrStatus !== 'pending' && (
            <OcrStatusBadge
              status={invoice.ocrStatus}
  ...
  if (selectionMode) {
    return (
      <div
        ...
        onClick={() => invoice.hasAttachment && onToggleSelect(invoice.id)}
      >
        {content}
      </div>
    );
      ...
      */}
      <div className="page-header-sticky">
        <div className="page-header-title flex items-center justify-between">
          <h1 className="page-title">{t('finance.invoices')}</h1>
          <button
            onClick={() => {
