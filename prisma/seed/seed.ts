...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      nameZh: '会计企业版',
      nameJa: '会計エンタープライズ',
      description: 'Enterprise-grade accounting (contact for quote)',
      descriptionZh: '企业级会计功能（询价）',
      descriptionJa: 'エンタープライズ級会計機能（お見積り）',
      productType: 'MODULE' as ProductType,
      category: 'MODULE' as ProductCategory,
      priceMonthly: 19800,
      includedModules: [],
    ...
    // === 导入服务 (ONBOARDING) ===
    {
      productCode: 'SV-DEP-SELF',
      name: 'Self-guided Onboarding',
      nameZh: '自助导入',
      nameJa: 'セルフガイド導入',
      description: 'Self-guided system setup',
      descriptionZh: '自助系统设置',
      descriptionJa: 'セルフガイドシステムセットアップ',
      productType: 'SERVICE' as ProductType,
    ...
    // === 硬件买断 (PURCHASE) ===
    {
      productCode: 'HW-PRN-80',
      name: 'Receipt Printer 80mm',
      nameZh: '80mm小票打印机',
      nameJa: '80mmレシートプリンター',
      description: 'Thermal receipt printer (purchase)',
      descriptionZh: '热敏小票打印机（买断）',
      descriptionJa: 'サーマルレシートプリンター（購入）',
      productType: 'HARDWARE' as ProductType,
      category: 'PURCHASE' as ProductCategory,
      priceMonthly: 12800,
      includedModules: [],
      odoo19ProductId: 55,
      sortOrder: 53,
    },
    {
      ...
      nameZh: 'KDS终端',
      nameJa: 'KDS端末',
      description: 'Kitchen display terminal (purchase)',
      descriptionZh: '厨房显示终端（买断）',
      descriptionJa: 'キッチンディスプレイ端末（購入）',
      productType: 'HARDWARE' as ProductType,
      category: 'PURCHASE' as ProductCategory,
      priceMonthly: 66800,
      includedModules: [],
    ...
    {
      productCode: 'HW-POS-DS',
      name: 'POS Dual Screen Set',
      nameZh: 'POS双屏套装',
      nameJa: 'POSデュアルスクリーンセット',
      description: 'POS with dual screen and cash drawer (purchase)',
      descriptionZh: 'POS双屏套装含钱箱（买断）',
      descriptionJa: 'POSデュアルスクリーン＋キャッシュドロワー（購入）',
      productType: 'HARDWARE' as ProductType,
      category: 'PURCHASE' as ProductCategory,
      priceMonthly: 79800,
      includedModules: [],
