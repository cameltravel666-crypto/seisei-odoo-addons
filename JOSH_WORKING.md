...
**Seisei ERP System** - 基于 Odoo 18 的企业资源管理系统

**核心服务：**
- 🏢 **Odoo18 ERP** - 主要的企业管理系统（库存、销售、财务等）
- 📸 **OCR服务** - 票据识别和自动录入
- 🌐 **Web网站** - 对外展示的官网
- 🤖 **Langbot** - AI客服机器人
...
| 环境 | 用途 | 访问地址 | 谁在用 |
|------|------|----------|--------|
| **Staging（测试环境）** | 测试新功能 | https://staging.erp.seisei.tokyo | 内部团队 |
| **Production（生产环境）** | 正式运营 | https://demo.nagashiro.top | 客户使用 |

**重要理解：**
- 🧪 **Staging** = 实验室，可以随意测试，出问题不影响客户
- 🏭 **Production** = 工厂，这是客户在用的，必须保持稳定
...
| 参数 | 填什么 | 示例 |
|------|--------|------|
| **Stack to deploy** | 选择要发布的服务 | `odoo18-prod` |
| **SHA tag** | 输入版本号 | `sha-19b9b98` |
| **Auto-promote** | 不勾选 | ⬜️ |
